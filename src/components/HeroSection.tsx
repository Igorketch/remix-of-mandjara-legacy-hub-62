      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        delay: 0.2
          ...
          delay: 0.7
            ...
            des peuples <strong className="text-heritage-gold">Bamoun</strong>, <strong className="text-heritage-gold">Nso'</strong> et <strong className="text-heritage-gold">Bafia</strong>
          </motion.p>
