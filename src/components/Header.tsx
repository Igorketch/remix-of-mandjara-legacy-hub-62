...
const teamSubLinks = [{
  ...
  href: '/team/membres-honneur'
}, {
  name: 'Conseil d\'Administration',
  href: '/team/conseil-administration'
}, {
  name: 'Bureau Exécutif',
  href: '/team/bureau-executif'
}, {
  name: 'Représentants nationaux',
  href: '/team/representants-nationaux'
}, {
  name: 'Comité des sages',
  href: '/team/comite-sages'
}];
export const Header = () => {
        ...
        <nav className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="relative">
              <img alt="International Mandjara Heritage" className="h-12 w-auto transition-transform duration-300 group-hover:scale-105" src="/lovable-uploads/99ac0785-119b-4f3b-8613-37a056986b4c.png" />
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-6 xl:gap-8">
            ...
            <div className="relative" onMouseEnter={() => setIsTeamDropdownOpen(true)} onMouseLeave={() => setIsTeamDropdownOpen(false)}>
              ...
              <AnimatePresence>
                {isTeamDropdownOpen && <motion.div initial={{
                opacity: 0,
                y: 10
              }} animate={{
                opacity: 1,
        ...
        <AnimatePresence>
          ...
          duration: 0.3
              ...
              delay: navLinks.length * 0.1
                  ...
                  <AnimatePresence>
                    {isMobileTeamOpen && <motion.div initial={{
                  opacity: 0,
                  height: 0
                }} animate={{
                  opacity: 1,
