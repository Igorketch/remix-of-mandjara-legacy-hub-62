        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-32 pb-20">
          ...
          >
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-heritage-gold/20 border border-heritage-gold/30 backdrop-blur-sm mb-8">
              ...
              <span className="text-heritage-gold text-sm font-medium">Les Trois Peuples Fondateurs</span>
            </span>
            <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-heritage-cream mb-6">
              Peuples <span className="text-gradient-gold">Mandjara</span>
            </h1>
            <p className="text-heritage-cream/80 text-lg sm:text-xl max-w-3xl mx-auto leading-relaxed">
              Découvrez les trois grands peuples du Cameroun qui forment le cœur de l'International 
              Mandjara Heritage : les Bamoun, les Nso' et les Bafia.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <h2 className="font-serif text-3xl lg:text-5xl font-bold text-heritage-cream mb-8">
              Unis par l'Histoire, la Culture et la <span className="text-heritage-gold">Fraternité</span>
            </h2>
            <p className="text-heritage-cream/80 text-lg leading-relaxed mb-8">
              Ces trois peuples partagent des liens historiques, linguistiques et culturels profonds. 
              L'International Mandjara Heritage œuvre pour renforcer ces liens et préserver ce 
              patrimoine commun pour les générations futures.
            </p>
            <div className="inline-flex items-center gap-4 px-8 py-4 rounded-full bg-heritage-gold/10 border border-heritage-gold/20">
              ...
              <span className="text-heritage-cream font-medium">
                Trois peuples, une même famille
              </span>
            </div>
          </motion.div>
        </div>
